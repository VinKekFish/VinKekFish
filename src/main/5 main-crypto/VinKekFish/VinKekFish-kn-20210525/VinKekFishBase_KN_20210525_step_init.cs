...
// TODO: посмотреть в тестах, что исходный tweak не изменяется
        ...
        /// <param name="TweakInit">Инициализатор Tweak (дополнительная синхропосылка), может быть null или инициализирован нулями. (массив: два значения по 8-мь байтов)</param>
