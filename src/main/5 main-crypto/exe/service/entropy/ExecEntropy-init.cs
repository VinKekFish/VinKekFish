...
public partial class Regime_Service
{
    ...
    public CascadeSponge_mt_20230930  CascadeSponge = new(OutputStrenght, ThreadsCount: 1) { StepTypeForAbsorption = CascadeSponge_1t_20230905.TypeForShortStepForAbsorption.weak };
