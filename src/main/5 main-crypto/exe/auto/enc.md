...
Пароль для табличного ввода может состоять из следующих символов
qWERTYUioPASdFgHJKLZXCVBNM1234567890[+*/=&^%#@<_

Данный набор содержит каждую латинскую букву только в одном регистре для упрощения поиска.
