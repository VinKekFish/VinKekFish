...
public unsafe partial class Main_1_PWD_2024_1
{
    public partial class CryptDataClass: IDisposable
    {
        ...
        protected void DecryptStagePermutation(Record key, Record key_init, byte regime, out CascadeSponge_mt_20230930 sponge)
        {
            // Инициализация первой губки для гаммирования с обратной связью.
            sponge = new CascadeSponge_mt_20230930(_wide: wide, _tall: tall);
