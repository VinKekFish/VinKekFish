...
2. [НЕ РЕАЛИЗОВАНО] Генерация ключевого форматированного файла, специфичного для VinKekFish.
...
simple:размер_файла
```
Командой как включается генерация файла, так и назначается его размер в байтах.
