...
1. W=k
2. Провести инициализацию губки любым методом с обратной связью в виде операции +1
3. Взять ⌊64/W⌋ байтов выхода для ключа ThreeFish.
4. Провести 2\*k\*log(k) шагов каскада
...
7. Выполнить 2\*k\*log(k) шагов каскада
8. Если ключ был вычислен в первый раз, то перейти к пункту 3 и заново вычислить ключ ThreeFish
...
8. После прохождения всех левых губок перейти на шаг 5 и повторить шаги уже для правых губок и правых частей ключей ThreeFish. После инициализации правых частей ключей ThreeFish (с выполнением 2\*k\*log(k) шагов каскада после последней перезаписи части ключа) алгоритм проинициализирован полностью без дополнительных шагов.
