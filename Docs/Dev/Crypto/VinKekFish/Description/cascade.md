...
3. Для синхропосылки просто провести шаг. Для ключа провести countStepsForKeyGeneration шагов каскада (для того, чтобы обратная связь по данным, сгенерированным на шаге взятия выхода, прошла через все слои губки, с учётом возможной потери информации при взаимодействии данных).
...
Синхропосылка отделяется от ввода ключа одним холостым проходом в режиме xor (обычный ввод в губку без перезаписи) в ином режиме шифрования (имеется в виду однобайтовый номер режима), чем ввод синхропосылки и ввод ключа.
